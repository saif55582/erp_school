...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>main_asset/assets/dist/css/bootstrap-select.css">
  ...
  <script src="<?=base_url()?>main_asset/assets/dist/js/bootstrap-select.js"></script>
</head>
<body>
