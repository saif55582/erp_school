            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title my-title">Add Syllabus</h4>
                        <form method="post" class="classform form-horizontal" enctype="multipart/form-data" action="<?=base_url()?>syllabus/add">
	                            ...
	                            <div class="row">
	                                <div class="col-md-4">
	                                    <div class="form-group label-floating is-empty">
	                                        <input type="text" value="" name="title" class="form-control up_case" required>
