	                                ...
	                                <div class="row">
		                                <div class="col-md-4">
		                                    <div class="form-group label-floating is-empty">
		                                        ...
		                                        <input type="text" value="<?=set_value('exam_name')?>" name="exam_name" class="form-control up_case" required>
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="row">
		                                <div class="col-md-4">
		                                    <div class="form-group label-floating is-empty">
		                                        <label class="control-label"></label>
		                                        <input type="text" value="<?=set_value('description')?>" name="description" class="form-control up_case" required>
