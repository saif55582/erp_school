                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12" style="background-color: #eee; border-radius: 5px; border: solid 1px #b11919;">
                                <form>
                                    ...
                                    <div onclick="setFocus();" class="col-sm-4 mytargetchange">
                                        <select name="feeID" id="class" data-live-search="true" class="selectpicker" data-style="select-with-transition" title="Select Year">
                                            <option value="JAN">2013</option>
                                            <option value="FEB">2014</option>
                                            <option value="MAR">2015</option>
