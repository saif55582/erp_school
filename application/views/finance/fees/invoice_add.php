                        ...
                        <form method="post" class="classform form-horizontal" action="<?= base_url('fees/insert_invoice'); ?>">
                    		...
                    		<div class="row">
                            	...
                            	<div onclick="setFocus()" class="col-sm-3 mytargetchange">
                                    <select name="classesID" id="class" onchange="getStudentOption(this.value,'<?=base_url()?>');" data-live-search="true" class="selectpicker" data-style="select-with-transition" title="Select Class" required="true">
                                        <?php
                                ...
                                <div onclick="setFocus()" class="col-sm-5 mytargetchange">
                            ...
                            <div class="row">
	                                    ...
	                                    <select name="concession_type" id="fee" data-live-search="true" class="selectpicker" data-style="select-with-transition" title="Select Concession">
	                                        <?php
	                                            ...
	                                            foreach($concession as $cons):
	                                                    echo "<option value='".$cons->fee_listID."'>".strtoupper($cons->concession_type)." (".$cons->discount."%)</option>";
	                                            endforeach;
                                ...
                                <div onclick="setFocus()" class="col-sm-6 mytargetchange">
                                    <select name="month[]" class="selectpicker" data-style="select-with-transition" title="Select Months" required="true" multiple="true">
